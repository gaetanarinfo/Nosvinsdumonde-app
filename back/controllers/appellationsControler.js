...
module.exports = {
    ...
    get: async (req, res) => {
        ...
        let sql = `SELECT * FROM appellation WHERE 1 ORDER BY id LIMIT 24`;
        db.query(sql, (error, data, fields) => {
            if (error) throw error;
            res.json({
                status: 200,
                listAppellations: data,
                message: "appellations lists retrieved successfully"
            })
        })
    },
    getAppellationsAll: async (req, res) => {
        ...
        db.query(sql, (error, data, fields) => {
            ...
            res.json({
                status: 200,
                listAppellationsAll: data,
                message: "vins appellations lists retrieved successfully"
            })
        })

    },
    getAppellationsTitle: async (req, res) => {
        ...
        db.query(sql, (error, data, fields) => {
            ...
            res.json({
                status: 200,
                listAppellationsTitle: data[0],
                message: "appellations lists retrieved successfully"
            })
        })

    },
    getAppellationsCount: async (req, res) => {
        ...
        db.query(sql, (error, data, fields) => {
            ...
            res.json({
                status: 200,
                listAppellationsCount: data.length,
                message: "vins appellations lists retrieved successfully"
            })
        })
