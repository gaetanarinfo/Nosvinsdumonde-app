<template>
  ...
  <div class="container-md q-mt-lg q-mb-lg" style="padding: 0 5vw" v-show="showSimulatedReturnData">
    <div class="col-lg-12">
      <div class="col-md-6">
        <div>
          <img style="border-radius: 10px; width: 100%" :src="
        ...
        <div class="text-white q-mt-md" style="display: flex; gap: 16px; justify-content: flex-end">
          ...
          <div>
            <a :href="
              ...
              decode(listNewsId.title) +
              '&amp;via=novinsdumonde'
            " onclick="window.open(this.href);return false;" style="color: #dc3e72; text-decoration: none"><i
                class="fa-brands fa-twitter"></i></a>
          </div>
        </div>

        <div class="text-white q-mt-md" v-html="decode(listNewsId.contentDescription)"></div>
        ...
        <div class="text-white q-py-sm" style="display: flex; gap: 16px">
          ...
          <div>
            <a href="https://twitter.com/share?url=https://nosvinsdumonde.com/fr/actualite/les-grands-crus-classes-en-1855-ouvrent-leurs-portes-et-leur-carnet-d-experiences&amp;text=Les grands crus classés en 1855 ouvrent leurs portes et leur carnet d'expériences&amp;via=novinsdumonde"
              onclick="window.open(this.href);return false;" style="color: #dc3e72; text-decoration: none"><i
                class="fa-brands fa-twitter"></i></a>
          </div>
        </div>
        ...
        <div class="q-mt-md" v-if="listNewsCommentsCount >= 1">
          <div class="plm mtm">
            <div v-for="comments in listNewsCommentsId" v-bind:key="comments.id" class="py-3 text-white">
              <span style="
                  font-weight: bold;
                  font-size: 16px;
                  color: burlywood;
                  text-transform: uppercase;
                "><i class="fa-solid fa-comment-dots q-mr-sm"></i>{{ comments.nom }}</span>

              <span style="font-weight: normal; font-size: 14px" class="q-ml-md">Le
        ...
        <div class="text-h5 text-white bloc_vin_title" style="
            font-size: 500;
            display: flex;
            margin: auto 0;
            margin-top: 2rem;
        ...
        <div class="q-mt-lg">
          <q-card class="card_actus q-mb-lg" v-for="news in listNewsReadMore" :key="news.id" flat>
            ...
            <q-card-section>
              <div class="text-h6 q-mt-sm q-mb-xs text-bold">
                <q-item :to="'/actualite/' + news.url" @click="actuBtn(news.url)"
                  style="text-decoration: none; color: black; padding: 0 0">{{ decode(news.title) }}</q-item>
              </div>
  ...
  <template>
    <q-dialog v-model="modal" persistent transition-show="rotate" transition-hide="rotate">
