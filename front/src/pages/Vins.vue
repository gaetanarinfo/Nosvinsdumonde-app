<template>
  <div class="row items-start" style="padding: 0 5vw; flex-direction: column">
    <div
      ...
      "
    >
      <q-item class="title">VINS</q-item>
    </div>

    <q-item class="q-pa-none text-white">
      Rouges, rosés, blancs et pétillants, les vins représentent un univers
      envoûtant. Contemplez leurs robes, découvrez leur palette aromatique et
      leurs saveurs... et partez à la découverte de toutes les facettes des
      vins. Parcourez les dégustations de nos œnologues et découvrez les
      procédés vinicoles des différents domaines de France et du monde à travers
      nos fiches produits.
    </q-item>
    ...
    <div class="q-pa-none q-mt-lg q-gutter-sm">
      <q-breadcrumbs class="text-brown">
        ...
        <q-breadcrumbs-el
          ...
          style="color: #ffc107"
        />
        <q-breadcrumbs-el label="Vins" style="color: white" />
      </q-breadcrumbs>
    </div>
